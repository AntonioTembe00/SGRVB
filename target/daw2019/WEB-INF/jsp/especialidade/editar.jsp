...
<html lang="en">
    ...
    <head>
        ...
        <title>sgrbv-Tela de Administrador-ActualizarEspecialidade</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Especialidade do Funcionario</h1>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3">
                                        <form action="<c:url value='/especialidade/edita1'/>" class="needs-validation" novalidate>
                                            <div class="form-group">
                                                <input type="hidden" name="id" value="${entity.id }" >
                                                <label for="uname"><b>Nome:</b></label>
                                                <input type="text" class="form-control" id="nome" name="nome" value="${entity.nome}" placeholder="Introduza o nome da especialidade" name="nome">
                                                
                                            </div>
                                            <div class="form-group">
                                                <label for="comment"><b>Descrição:</b></label>
                                                <textarea class="form-control" rows="5" id="comment" name="descricao" value="${entity.descricao}" placeholder="Introduza a Descrição da especialidade"></textarea>
                                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" href="<url value ='/login'/>">Sair</a>
                    </div>
                </div>
            </div>
        </div>
