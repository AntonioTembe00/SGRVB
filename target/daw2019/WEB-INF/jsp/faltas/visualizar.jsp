...
<html lang="en">
    ...
    <head>
        ...
        <title>sgrbv-Tela de Administrador-Faltas</title>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <c:forEach items="${list}" var="entity">
                                            <tr>
                                                ...
                                                <td>
                                                    <a style="margin-left: 23%" href="justificar?id=${entity.id}" class="btn btn-warning btn-circle btn-sm" data-toggle="tooltip" data-placement="left" title="Confirmar">
