...
<html lang="en">
    ...
    <head>
        ...
        <title>sgrbv-Tela de Administrador-VisualizarCategoriaJogo</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Visualização de Categoria de Filmes</h1>
                        <br><br>  
                        <!-- DataTales Example -->
                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="entity">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a style="margin-left: 23%" href="edita?id=${entity.id}" class="btn-circle"  data-placement="left" title="actuaizar">
                                                             <img class="img-responsive" src="${pageContext.request.contextPath}/resources/assets/img/portfolio/ed.png" alt="">
                                                        </a>
                                                        <a style="margin-left: 20%" href="remove?id=${entity.id}" class="btn-circle"  title="apagar" data-placement="left">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-danger" href="<c:url value='/login'/>">Sair</a>
                    </div>
                </div>
            </div>
        </div>
