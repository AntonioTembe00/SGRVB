  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-gradient-primary bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <ul>
        	<li>
                    <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="<c:url value='/cliente/create'/>">Criar Conta</a>
        	</li>
        </ul>
        <ul>
        	<li>
                    <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="<c:url value='/logincliente'/>">Entrar na Conta</a>
        	</li>
        </ul>
      </div>
    </div>
