...
<html lang="en">
    ...
    <head>
        ...
        <title>sgrbv-Tela de Administrador-editarTipoPagamento</title>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3">
                                        <form action="<c:url value='/tipopagamento/edita1'/>" class="needs-validation" novalidate>
                                            <input type="hidden" name="id" value="${entity.id }" >
                                            <div class="form-group">
                                                <label for="uname"><b>Nome:</b></label>
                                                <input type="text" class="form-control"  name="nome" placeholder="Introduza o nome do Tipo de Pagamento" name="nome" value="${entity.nome }">
                               
                                            </div>
                                            <div class="form-group">
                                                <label for="comment"><b>Descrição:</b></label>
                                                <textarea class="form-control" rows="5" id="comment" name="descricao" placeholder="Introduza a Descrição do Tipo de Pagamento" value=" ${entity.descricao }"></textarea>
                                            </div>
