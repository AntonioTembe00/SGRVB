...
<html lang="en">
    ...
    <head>
        ...
        <title>sgrbv-Tela de Administrador-RegistarTipoPagamento</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Registo dos Tipos de Pagamento</h1>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3">
                                        <form action="<c:url value='/tipopagamento/add'/>" class="needs-validation" novalidate>
                                            <input type="hidden" name="id" value="${entity.id }" >
                                            <div class="form-group">
                                                <label for="uname"><b>Nome:</b></label>
                                                <input type="text" class="form-control"  name="nome" placeholder="Introduza o nome do Tipo de Pagamento" name="nome" required>
                                                <!-- <div class="valid-feedback">Valido.</div> -->
                                                <div class="invalid-feedback">Obrigatório preencher.</div>
                                            </div>
                                            <div class="form-group">
                                                <label for="comment"><b>Descrição:</b></label>
                                                <textarea class="form-control" rows="5" id="comment" name="descricao" placeholder="Introduza a Descrição do Tipo de Pagamento"></textarea>
                                            </div>
