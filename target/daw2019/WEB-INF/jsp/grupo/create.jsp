            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Registo de Grupo Utilizador</h1>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3">
                                        <form action="<c:url value='/grupo/add'/>" class="needs-validation" novalidate>
                                            <input type="hidden" name="id" value="${entity.id }" >
                                            <div class="form-group">
                                                <label for="uname"><b>Nome:</b></label>
                                                <input type="text" class="form-control"  name="nome" placeholder="Introduza o nome da categoria" name="nome" required>
