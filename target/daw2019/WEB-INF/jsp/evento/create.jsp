...
<html lang="en">
    ...
    <head>
        ...
        <title>sgrbv-Tela de Administrador-RegistarEvento</title>
...
<!--                <li class="nav-item">
        ...
        <!-- Page Wrapper -->
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Registo de Eventos</h1>
                                    ...
                                    <div class="card-header py-3">
                                        <form action="<c:url value='/evento/add'/>" class="needs-validation" novalidate>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control"  name="bilhetesDisponiveis" required>
                                                <!-- <div class="valid-feedback">Valido.</div> -->
                                                <div class="invalid-feedback">Obrigatório preencher.</div>
                                            </div>                                                                                   
                                            <div class="form-group">
                                                <label for="comment"><b>Descrição:</b></label>
                                                <textarea class="form-control" rows="5" id="comment" name="descricao" placeholder="Introduza a Descrição do Evento"></textarea>
                                            </div>
