...
<html lang="en">
    ...
    <head>
        ...
        <title>sgrbv-Tela de Administrador-RegistarFuncionário</title>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3">
                                        <form action="<c:url value='/funcionario/edita1'/>" class="needs-validation" novalidate>
                                            <input type="hidden" name="id" value="${entity.id }" >
                                            <div class="form-group">
                                                <label for="uname"><b>Nome:</b></label>
                                                <input type="text" class="form-control"  name="nome" value="${entity.nome }" placeholder="Introduza seu nome" name="nome">

                                            </div>
                                            <div class="form-group">
                                                <label for="uname"><b>Email:</b></label>
                                                <input type="text" class="form-control"  name="email" value="${entity.email }"placeholder="Introduza seu email" name="email">
                                            ...
                                            <div class="form-group">
                                                <label for="bi"><b>BI:</b></label>
                                                <input type="text" class="form-control"  name="bi" value="${entity.BI }"placeholder="Introduza seu BI" required>
                                                <!-- <div class="valid-feedback">Valido.</div> -->
                                                <div class="invalid-feedback">Obrigatório preencher.</div>
                                            </div>
                                            <div class="form-group">
                                                <label for="telefone"><b>Telefone:</b></label>
                                                <input type="text" class="form-control"  name="telefone" value="${entity.telefone }" placeholder="Introduza seu numero de telefone"  required>
                                                <!-- <div class="valid-feedback">Valido.</div> -->
                                                <div class="invalid-feedback">Obrigatório preencher.</div>
                                            </div>
                                            <div class="form-group">
                                                <label for="salario"><b>Salário:</b></label>
                                                <input type="t" class="form-control"  name="salario" value="${entity.salario }" placeholder="Introduza seu salário"  required>
                                                <!-- <div class="valid-feedback">Valido.</div> -->
                                                <div class="invalid-feedback">Obrigatório preencher.</div>
                                            </div>
                                            <div class="form-group">
