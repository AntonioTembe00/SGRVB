...
<html lang="en">
    ...
    <head>
        ...
        <title>sgrbv-Tela de Administrador-ActualizarCategoriaJogo</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Categorias de Jogo</h1>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3">
                                        <form action="<c:url value='/categoria/edita1'/>" class="needs-validation" novalidate>
