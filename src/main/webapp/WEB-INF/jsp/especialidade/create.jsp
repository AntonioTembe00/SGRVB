...
<html lang="en">
    ...
    <head>
        ...
        <title>sgrVb-Tela de Administrador-RegistarEspecialidade</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Registo das Especialidades</h1>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3">
                                        <form action="<c:url value='/especialidade/add'/>" class="needs-validation" novalidate>
                                            <div class="form-group">
                                                <input type="hidden" name="id" value="${entity.id }" >
                                                <label for="uname"><b>Nome:</b></label>
                                                <input type="text" class="form-control" id="nome" name="nome" value="${entity.nome}" placeholder="Introduza o nome da especialidade" name="nome" required>
