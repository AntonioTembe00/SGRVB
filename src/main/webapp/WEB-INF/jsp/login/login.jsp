...
<html lang="pt-pt">
    ...
    <head>
        ...
        <title>SGRBV - CrendenciasAdmin</title>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-lg-6 d-none d-lg-block">
                                    <img src="${pageContext.request.contextPath}/resources/assets/img/pep.jpg" alt="">
                                </div>
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form class="user" action="<c:url value='/login/entrar'/>">
