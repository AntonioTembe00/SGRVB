...
<html lang="en">
    ...
    <head>
        ...
        <title>sgrbv-Tela de Administrador-VisualizarEvento</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Visualização de Eventos de Filme</h1>
                        <br><br>  
                        <!-- DataTales Example -->
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="entity">
                                                <tr>
                                                    <td>${entity.jogo}</td>
                                                    <td>${entity.datajogo}</td>
                                                    <td>${entity.valor}</td>
                                                    <td>${entity.bilhetesDisponiveis}</td>
