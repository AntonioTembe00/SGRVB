...
<html lang="en">
    ...
    <head>
        ...
        <title>sgrbv-Tela de Administrador-ActualizarEvento</title>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3">
                                        <form action="<c:url value='/evento/edita1'/>" class="needs-validation" novalidate>
                                            ...
                                            <div class="form-group">
                                                <label for="data"><b>Data Jogo</b></label>
                                                <input type="date" class="form-control"  name="data" >

                                            </div>
                                            <div class="form-group">
                                                <label for="uname"><b>Valor Bilhete:</b></label>
                                                <input type="number" class="form-control"  name="valor" value="${entity.valor}">

                                            </div>
                                            <div class="form-group">
                                                <label for="uname"><b>Numero Bilhetes:</b></label>
                                                <input type="number" class="form-control"  name="bilhetesDisponiveis" value="${entity.bilhetesDisponiveis}">

                                            </div>                                                                                   
                                            <div class="form-group">
                                                <label for="comment"><b>Descrição:</b></label>
                                                <textarea class="form-control" rows="5" id="comment" name="descricao" placeholder="Introduza a Descrição do Evento" value="${entity.descricao}"></textarea>
                                            </div>
