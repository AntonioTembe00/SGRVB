...
<html lang="en">
    ...
    <head>
        ...
        <title>sgrbv-Tela de Administrador-AtribuiçãoFérias</title>
...
<!--                <li class="nav-item">
        ...
        <!-- Page Wrapper -->
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Atribuir de Férias</h1>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3">
                                        <form action="<c:url value='/ferias/add'/>" class="needs-validation" novalidate>
                                            <input type="hidden" name="id" value="${entity.id }" >
                                            <div class="form-group">
                                                <label for="sel1">Funcionário:</label>
                                                <select class="form-control" id="sel1" name="funcionario">
                                                    <option value="selecione">Selecione Funcionário</option>
                                                    <c:forEach items="${funcionariolista}" var="fun">
                                            ...
                                            <div class="form-group">
                                                <label for="da"><b>Data Inicio</b></label>
                                            ...
                                            <div class="form-group">
                                                <label for="da"><b>Data Fim</b></label>
                                                <input type="date" class="form-control"  name="datafim" required>
                                                <!-- <div class="valid-feedback">Valido.</div> -->
                                                <div class="invalid-feedback">Obrigatório preencher.</div>
                                            </div>
                                            
                                            <button type="submit" class="btn btn btn-success">Atribuir</button>
