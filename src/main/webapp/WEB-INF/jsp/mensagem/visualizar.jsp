                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="entity">
                                                <tr>
                                                    ...
                                                    <td>${entity.assunto}</td>
                                                    <td>${entity.descricao}</td>
                                                    <td>${entity.data}</td>

                                                    <td>
                                                        <a style="margin-left: 23%" href="edita?id=${entity.id}" class="btn btn-warning btn-circle btn-sm" data-toggle="tooltip" data-placement="left" title="Responder Mensagem">
