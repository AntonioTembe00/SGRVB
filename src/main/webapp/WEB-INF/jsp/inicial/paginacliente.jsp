    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 ml-auto">
          <p class="lead">Somos um cinema que tem como seu principal objectivo proporcionar diversÃ£o aos clientes.</p>
        </div>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <p class="mb-5"> <b>DESCRIÇÃO:</b> Titulo original : Joker
                  ...
                  <p><b>SINOPSE:</b> O comediante falido Arthur Fleck encontra violentos bandidos pelas ruas de Gotham City. Desconsiderado pela sociedade, Fleck começa a ficar louco e se transforma no criminoso conhecdo como Coringa.</p>

                  <br>
					<table class="table">
				    <thead class="thead-dark">
				      <tr>
				        <th>Reservar bilhetes</th>
				      </tr>
				    </thead>
				    <tbody>
				  		<tr>
					      	<td>
					      	 Data: ${lista.datafilme}
					      	</td>
					      </tr>
                                               <tr>
                                                  	<td>
				  ...
				  <a href="http://localhost:8082/daw2019/reserva/create" class="btn btn-secondary">
                      Registar
                    </a>
                  <br>
                  <br>
